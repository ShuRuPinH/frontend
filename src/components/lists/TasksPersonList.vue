<template>
  ...
  <div  @click="$emit('opentask',  item2) " class="sticker-left sticker-warning  text-center"
        v-for="(item2,id) in fromParent[0]" :key="id" :value="item2" :data-sticker="item2.name ==null ? 'n/a' : item2.name">
